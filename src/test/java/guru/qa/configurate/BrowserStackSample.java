...
public class BrowserStackSample implements WebDriverProvider {

    public static final OwnerData CONFIG = ConfigFactory.create(OwnerData.class, System.getProperties());
    ...
    public WebDriver createDriver(Capabilities capabilities) {
        ...
        OwnerData config = ConfigFactory.create(OwnerData.class, System.getProperties());
